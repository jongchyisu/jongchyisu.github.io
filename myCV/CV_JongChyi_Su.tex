...
\begin{itemize}
\item Worked with Dr. Hyoduk Shin to help solve an optimization problem about the pricing strategy for supply chain.% with information asymmetry.
\end{itemize}
\vspace{5pt}
...
%\hrule \vspace{10pt}
%{Programming Languages:} python, \textsc{MATLAB}, C/C++.\\
%\vspace{-12pt}
